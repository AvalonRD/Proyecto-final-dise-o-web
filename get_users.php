        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td><form name='form-modificar' action='modificar_regitro.php'><input type='hidden' name='id_usuario' value='" . htmlspecialchars($row['user_id']) . "'><input type='submit' value='Modificar'></form></td>
                        <td><button onclick='borrar_registro(" . htmlspecialchars($row['user_id']) . ")'>Borrar</button></td>
                    </tr>";
            }
        } else {
